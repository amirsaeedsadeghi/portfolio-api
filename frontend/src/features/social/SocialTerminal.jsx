...
function SocialTerminal({ aboutMe }) {
    ...
    const {stage,isProcessing,isCurrentOutputVisible} = useSocialShell();
    ...
    const isLogoutCommandVisible =
        stage >= SHELL_STAGE.LOGOUT;
    ...
    return (
        <TerminalWindow contentRef={terminalContentRef}>
            <div className="terminal-font text-[13px] leading-6 text-[#d6deeb] sm:text-sm md:text-[15px] md:leading-7">
                <div className="mb-6">
                    <p>
                        Last login: {sessionTime} on ttys001
                    </p>
                ...
                {isSocialCommandVisible && (
                    <TerminalPrompt
                        command="cat ~/.social"
                        active={stage === SHELL_STAGE.SOCIAL && !isProcessing}
                    />
                )}
                        ...
                        {linkedinUrl && (
                            <p>
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="text-[#c792ea] underline decoration-transparent underline-offset-4 transition-colors hover:text-[#d6deeb] hover:decoration-current"
                                >
                                    {linkedinUrl}
                                </a>
                            </p>
